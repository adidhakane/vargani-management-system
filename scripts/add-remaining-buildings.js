// Script to add residents data for buildings 4, 5, 6, and 7
...
async function addResidents() {
  try {
    console.log('🏗️  Starting to add residents for buildings 4, 5, 6, and 7...');
    ...
    console.log('\n📊 Summary:');
    console.log(`✅ Successfully added: ${successCount} residents`);
    console.log(`⚠️  Skipped (already exists): ${skipCount} residents`);
    ...
    console.log(`🏗️  Total residents in database: ${totalCount}`);
